...
1. Whether you followed the [Google Java Style Guide](https://google.github.io/styleguide/javaguide.html).  
2. Your actual program design: do you have a monolithic main function (bad), or did you appropriately use helper functions to decompose the problem (good)?
...
Do we have to use GitHub?
  : Not this semester (Spring 2024).
...
Samuel A. Rebelsky made a few more changes in Spring 2024.
